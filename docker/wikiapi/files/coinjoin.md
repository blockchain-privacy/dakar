...
users and the transaction outputs can not be clearly linked to the transaction inputs. In most CoinJoin systems, this kind of transaction is created multiple times in succession to further obscure the ownership of the funds.
