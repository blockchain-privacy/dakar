...
Destination transaction fingerprinting compares the connected time frames of the analysed destination transaction with all other destination transactions. Its result are destination transactions which spend outputs from similar time frames.
