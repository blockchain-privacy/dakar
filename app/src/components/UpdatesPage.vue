      ...
      >
        <v-card-text>
          <div class="d-flex align-center mb-3">
            ...
            <div class="ms-auto text-body-large">
...
import {PAGE_TITLE, UPDATE_ID} from '@/constants/index.js';
...
onMounted(() => {
	document.title = `Updates - ${PAGE_TITLE}`;
	localStore.setLastUpdateID(UPDATE_ID);
});
