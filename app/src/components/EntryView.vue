                    ...
                    <v-list-item-content>
                      <v-list-item-title>
                        ...
                        <v-tooltip right>
                          ...
                          <span>{{ tooltips.highestBlockId }}</span>
                        </v-tooltip>
                      </v-list-item-title>
                      <v-list-item-subtitle>
                        <router-link :to="'search/' + data.highestblockid">{{ data.highestblockid }}</router-link>
                      </v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
                </v-col>
  ...
  computed: {
    ...
    tooltips() {
      return {
        ...
        highestBlockId: "The highest block ID in the database",
