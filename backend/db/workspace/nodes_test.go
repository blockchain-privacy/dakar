...
func Test_getWorkspaceConnectionsRaw(t *testing.T) {
	...
	txUID, err := db.GetTransactionUID(dbHandle, "91609034d29949f9e19dc62637f0665bdc1b161e11b7f360ee692d15b46c8cdb")
	require.NoError(t, err)
	txUID2, err := db.GetTransactionUID(dbHandle, "ae52511e1f61977ee2993e47f387d6fe409140dee5783f6df07703360c81a542")
	require.NoError(t, err)
	addressUIDs, err := db.GetAddressUIDs(dbHandle, []string{"XqwLfPeZSQb9z1QFbCaDkvNQvfutRR4JL3"})
	require.NoError(t, err)
