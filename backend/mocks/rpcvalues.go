...
type RPCValues struct {
	...
	TxHashes             []string
	TxRawResults         []btcjson.TxRawResult
...
func init() {
	...
	txHashes := []string{"9b75129c5d8538287e3c34035da0420905b6ff1651f06a6f292392bc825a4af5",
	...
	txRawResult1 := btcjson.TxRawResult{
	...
	txMap[*txHash1] = txRawResult1

	txRawResult2 := btcjson.TxRawResult{
	...
	txMap[*txHash2] = txRawResult2

	txRawResult3 := btcjson.TxRawResult{
		Hex:      "",
		Txid:     "83958bf3982d4ad722a1e39c06d6049a0e4e48d2146ac2791dfbc193302b20cf",
		Hash:     "",
		Size:     222,
		Vsize:    0,
		Weight:   0,
	...
	txMap[*txHash3] = txRawResult3

	txRawResults := []btcjson.TxRawResult{txRawResult1, txRawResult2, txRawResult3}
